...
{
    public class PartyOrderInvoiceServiceMapper : BaseMapper<DALAppDTO.PartyOrderInvoice, BLLAppDTO.PartyOrderInvoice>, IPartyOrderInvoiceServiceMapper
    {
        public PartyOrderInvoiceServiceMapper() : base()
        {
