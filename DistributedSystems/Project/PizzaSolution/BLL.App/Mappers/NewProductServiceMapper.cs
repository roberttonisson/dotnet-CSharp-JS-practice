...
{
    public class NewProductServiceMapper : BaseMapper<DALAppDTO.NewProduct, BLLAppDTO.NewProduct>, INewProductServiceMapper
    {
        public NewProductServiceMapper() : base()
        {
            ...
            MapperConfigurationExpression.CreateMap<DALAppDTO.NewProduct, BLLAppDTO.NewProduct>();
