...
{
    public class DrinkInCartServiceMapper : BaseMapper<DALAppDTO.DrinkInCart, BLLAppDTO.DrinkInCart>, IDrinkInCartServiceMapper
    {
        public DrinkInCartServiceMapper() : base()
        {
